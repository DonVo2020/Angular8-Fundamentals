...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    private authenticationService: AuthIntercetorsService) {
  }
  ...
  ngOnInit() {
    ...
    this.returnUrl = this.route.snapshot.queryParamMap.get('returnUrl') || '/authentication-interceptors/home-boy';
  }
