...
function validateEmail(control: AbstractControl) {
  ...
  return re.test(email) ? null : { 'no valid email': true };
}
...
@Component({
  selector: 'app-forms-model-driven2',
  templateUrl: './forms-model-driven2.component.html'
})
export class FormsModelDriven2Component implements OnInit  {
